...
MyMainWindow::MyMainWindow(QWidget *parent)
	: QMainWindow(parent), picture_window_(NULL), track_window_(NULL), track_comparison_window_(NULL), picture_track_window_(NULL)
{
	ui.setupUi(this);
	...
	connect(ui.actionStart_4, SIGNAL(triggered()), this, SLOT(ChangeToPictureTrackWindow()));
}
...
void MyMainWindow::ChangeToPictureTrackWindow()
{
	//SAFEDELETE(opengl_window_);
	picture_track_window_ = new PictureTrackWindow(this);

	picture_track_window_->show();
	//this->hide();
}
