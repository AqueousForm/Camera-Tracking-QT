...
// 
// void OpenglWindow::ChangeToPictureWindow()
// {
...
void OpenglWindow::Open_3DPoint()
{
...
void OpenglWindow::VisualizeFrame()
{
	if (filepath_.isEmpty())
		return;
...
// 
// void OpenglWindow::VisualizeFrame_1()
// {
// 	if (filepath_1.isEmpty())
// 		return;
// 
...
void OpenglWindow::Visualize3DPoint()
{
	if (filepath_3DPoint.isEmpty())
		return;
...
/* void OpenglWindow::CreateActions_1()
{
	// file menu
