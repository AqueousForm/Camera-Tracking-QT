	...
	: QMainWindow(parent)
{
	...
	for (int i = 0; i < ptr_inputdialog->number; i++){

		Open(i, ptr_inputdialog->number);
	}
...
void TrackComparisonWindow::Open(int i, int num)
{
	filepath_[i] = QFileDialog::getOpenFileName(this,
		tr("Open File"),
